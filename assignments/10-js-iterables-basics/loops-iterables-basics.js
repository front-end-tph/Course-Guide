...
var modifiedNamesList = simpOrSamp(modifiedNamesList)
...
////------------------------------------------------------------------
// TASK 2 : Build a function that returns an array of strings with last names added:
//    If less than 6 characters, append Sampson: e.g. "Homer Sampson"
//    If 6 characters or longer, append Simpson: 'Jessica Simpson'
////------------------------------------------------------------------
...
var simpSampList = simpOrSamp(modifiedNamesList)
console.assert( simpSampList[1] === "OJ Sampson" )
console.assert( simpSampList[2] === "Marge Sampson" )
console.assert( simpSampList[5] === "Maggie Simpson" )
